export const DisclaimerConfig = {
  content: [
    ...
    "Patria Parivaar offers pooja (traditional worship) at Chabootras (stone masonry platforms), specifically dedicated to above mentioned Satimata at Yagnapur (Jahazpur) village of Rajasthan state in India",
